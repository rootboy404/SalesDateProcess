...
public class ResumeDataService {
    ...
    public static final String MORE_EXPANSIVE_SALESMAN_TEXT_TEMPLATE = "More Expansive Salesman: ";
    public static final String WORST_SELLER_TEXT_TEMPLATE = "The Worst seller: ";

    public  void createResumeFile(String fileName, Integer quantityClient, Integer quantitySalesman, String idMoreExpensiveSale, String worstSeller) throws IOException {
    ...
    private  String createTemplate(String fileName, Integer quantityClient, Integer quantitySalesman, String idMoreExpensiveSale, String worstSeller) {
        return TITLE_TEXT_TEMPLATE.concat(fileName).concat("\n").concat(
                ...
                MORE_EXPANSIVE_SALESMAN_TEXT_TEMPLATE).concat(idMoreExpensiveSale).concat("\n").concat(
